...
<div class="flex flex-col gap-4">
    <div class="flex flex-row justify-center space-x-40 mb-20">
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(0)}>
        ...
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(1)}>
            <div class="w-20 h-20 overflow-hidden">
        ...
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(2)}>
            <div class="w-20 h-20 overflow-hidden">
    ...
    <div class="flex flex-row justify-center space-x-40 mb-20">
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(3)}>
            <div class="w-20 h-20 overflow-hidden">
        ...
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(4)}>
            <div class="w-20 h-20 overflow-hidden">
        ...
        <button class="btn btn-lg btn-circle btn-primary text-sm text-base-content" on:click={() => selection(5)}>
            <div class="w-20 h-20 overflow-hidden">
